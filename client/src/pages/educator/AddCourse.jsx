...
const AddCourse = () => {
  ...
  return (
    <div className='h-scrren overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
              ...
              <div className='p-4'>
                {chapter.chapterContent.map((lectureDetails,lectureIndex)=>(
                  <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                   <span>{lectureIndex+1}{lectureDetails.lectureTitle}-{lectureDetails.lectureDuration}
                    mins - <a href={lectureDetails.lectureUrl} target="_blank" className='text-blue-500'
                    >Link</a> - {lectureDetails.isPreviewFree ? 'Free Preview' : 'Paid'}
                      </span>
            ...
            <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
              ...
              <div className='mb-2'>
               ...
               <div className='mb-2'>
                ...
                checked={lectureDetails.lectureisPreviewFree}
                onChange={(e)=>setLectureDetails({...lectureDetails,isPreviewFree:e.target.checked})} />
              </div>
              <button type='button' className='w-full bg-blue-400 text-white px-4 py-2 rounded' onClick={addLecture}>Add</button>
              <img onClick={()=>setShowPopup(false)} src={assets.cross_icon} className='absolute top-4 right-4
              w-4 cursor-pointer' alt=""/>
            </div>
